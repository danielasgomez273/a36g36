...
CREATE TABLE IF NOT EXISTS "carrito" (
                ...
                "id_pago_fk"	INTEGER NOT NULL,
                "id_paciente_fk"	INTEGER NOT NULL,
                "paquetes_agregados"	TEXT NOT NULL,
                "estado_carrito"	TEXT NOT NULL,                
                FOREIGN KEY("id_pago_fk") REFERENCES "informacion_pago"("id_informacion_pago"),
                FOREIGN KEY("id_paciente_fk") REFERENCES "paciente"("id_paciente"),
                PRIMARY KEY("id_carrito" AUTOINCREMENT)
            );


/* ##################################### creamos tabla INFORMACION DE PAGO MODIFICACION 2023 ##################################### */ 
CREATE TABLE IF NOT EXISTS "informacion_pago" (
                "id_informacion_pago"	INTEGER NOT NULL,
                "id_factura_fk"	INTEGER NOT NULL UNIQUE,
                "estado_pago" TEXT NOT NULL,                
                FOREIGN KEY("id_factura_fk") REFERENCES "factura"("id_factura"),
                PRIMARY KEY("id_informacion_pago" AUTOINCREMENT)
            );
